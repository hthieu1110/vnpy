...
class PortfolioManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        resize_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Resize Columns")
        ...
        hbox1.addStretch()
        hbox1.addWidget(QtWidgets.QLabel("Refresh Rate"))
        hbox1.addWidget(interval_spin)
        hbox1.addStretch()
        hbox1.addWidget(QtWidgets.QLabel("Portfolio Trades"))
    ...
    def update_trades(self) -> None:
        ...
        for trade in trades:
            # Filter trades without reference
    ...
    def get_portfolio_item(self, reference: str) -> QtWidgets.QTreeWidgetItem:
        """"""
        portfolio_item: QtWidgets.QTreeWidgetItem | None = self.portfolio_items.get(
            reference, None
        )
