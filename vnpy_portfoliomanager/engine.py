...
from vnpy.trader.engine import MainEngine, EventEngine, BaseEngine
from vnpy.trader.event import EVENT_ORDER, EVENT_CONTRACT, EVENT_TIMER, EVENT_TRADE
...
class PortfolioEngine(BaseEngine):
    ...
    def get_portfolio_result(self, reference: str) -> PortfolioResult:
        """"""
        portfolio_result: PortfolioResult | None = self.portfolio_results.get(
            reference, None
        )
