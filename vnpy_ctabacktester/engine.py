...
class BacktesterEngine(BaseEngine):
    ...
    def init_engine(self) -> None:
        """"""
        self.write_log(_("Initialize CTA backtesting engine"))
        ...
        self.write_log(_("Strategy files loaded successfully"))
    ...
    def init_datafeed(self) -> None:
        ...
        if result:
            self.write_log(_("Data service initialized successfully"))
    ...
    def load_strategy_class_from_module(self, module_name: str) -> None:
        ...
        try:
            ...
            # Reload module to ensure any changes in strategy files take effect immediately.
    ...
    def reload_strategy_class(self) -> None:
        ...
        self.classes.clear()
        self.load_strategy_class()
        self.write_log(_("Strategy files reload completed"))
    ...
    def run_backtesting(
        ...
        if not engine.history_data:
            self.write_log(_("Strategy backtesting failed, historical data is empty"))
            self.thread = None
            return
    ...
    def run_optimization(
        ...
        # Clear thread object handler.
        self.thread = None
        self.write_log(_("Multi-process parameter optimization completed"))
