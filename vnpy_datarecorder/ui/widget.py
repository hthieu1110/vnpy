...
from ..engine import APP_NAME, EVENT_RECORDER_LOG, EVENT_RECORDER_UPDATE, RecorderEngine
...
class RecorderManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        grid.addWidget(QtWidgets.QLabel("Bar Recording"), 0, 0)
        ...
        grid2.addWidget(QtWidgets.QLabel("Bar Recording List"), 0, 0)
        grid2.addWidget(QtWidgets.QLabel("Tick Recording List"), 0, 1)
